...
async def test_semantic_directions():
    ...
    try:
        ...
        directions = [
            SemanticDirection.NORTH,
            SemanticDirection.SOUTH,
            SemanticDirection.EAST,
            SemanticDirection.WEST,
        ]
        ...
        print(
            f"Secondary Direction: {space.secondary_direction.value if space.secondary_direction else 'None'}"
        )
...
async def test_context_stability():
    ...
    try:
        ...
        for i, event in enumerate(events):
            ...
            print(
                f"  Strength: {vector.strength:.2f}, Confidence: {vector.confidence:.2f}"
            )
            ...
            if previous_vector:
                ...
                print(
                    f"  Stabilized: {stabilized.primary_direction.value} "
...
async def test_transition_navigation():
    ...
    try:
        ...
        transition_events = [
            ...
            (
                ...
                NavigationEvent(
                    "t2",
                    "crisis",
                    "Emergency situation requires action",
                    datetime.now(),
                    "perception",
                    -0.3,
                    0.9,
        ...
        for state, event in transition_events:
            ...
            print(
                f"  Vector: strength={direction_vector.strength:.2f}, confidence={direction_vector.confidence:.2f}"
            )
...
async def test_memory_compass():
    ...
    try:
        ...
        contexts = [
            ...
            NavigationContext(
                "creative_context", emotional_context={"excitement": 0.9}
            ),
    ...
    try:
        ...
        complex_events = [
            NavigationEvent(
                "c1",
                "problem_solving",
                "Facing a complex challenge that requires creative thinking",
                datetime.now(),
                "perception",
                0.4,
                0.6,
            ...
            NavigationEvent(
                "c2",
                "learning",
                "Need to understand the deeper principles",
                datetime.now(),
                "perception",
                0.6,
                0.4,
            ...
            NavigationEvent(
                "c3",
                "creation",
                "Now I can build an elegant solution",
                datetime.now(),
                "perception",
                0.8,
                0.7,
            ...
            NavigationEvent(
                "c4",
                "reflection",
                "Let me contemplate what I learned",
                datetime.now(),
                "perception",
                0.5,
                0.2,
            ...
            NavigationEvent(
                "c5",
                "integration",
                "Integrating all insights into wisdom",
                datetime.now(),
                "perception",
                0.9,
                0.3,
        ...
        for i, event in enumerate(complex_events, 1):
            ...
            print(
                f"  Metrics: str={vector.strength:.2f}, conf={vector.confidence:.2f}, stab={vector.stability:.2f}"
            )
            print()
