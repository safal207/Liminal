...
class TestTextSensor:
    ...
    async def test_analyze_positive_text(self):
        ...
        text_data = TextData(
            text="I feel amazing and happy today!", word_count=6, char_count=32
        )
    ...
    async def test_analyze_negative_text(self):
        ...
        text_data = TextData(
            text="I feel terrible and sad", word_count=5, char_count=24
        )
        sensor_data = SensorData(
            sensor_type=SensorType.TEXT,
            timestamp=datetime.now(),
    ...
    async def test_analyze_neutral_text(self):
        ...
        text_data = TextData(
            text="The weather is okay today.", word_count=5, char_count=26
        )
        sensor_data = SensorData(
            sensor_type=SensorType.TEXT,
            timestamp=datetime.now(),
    ...
    async def test_analyze_empty_text(self):
        ...
        text_data = TextData(text="", word_count=0, char_count=0)
        sensor_data = SensorData(
            sensor_type=SensorType.TEXT,
            timestamp=datetime.now(),
            raw_data=text_data,
...
class TestTouchSensor:
    ...
    async def test_analyze_gentle_touch(self):
        ...
        sensor_data = SensorData(
            ...
            data={"pressure": 0.3, "duration": 2.0, "pattern": "continuous"},
            timestamp=datetime.now(),
        )
    ...
    async def test_analyze_strong_touch(self):
        ...
        sensor_data = SensorData(
            sensor_type=SensorType.TOUCH,
            data={"pressure": 0.9, "duration": 0.5, "pattern": "sharp"},
            timestamp=datetime.now(),
        )
...
class TestAudioSensor:
    ...
    async def test_analyze_calm_audio(self):
        ...
        sensor_data = SensorData(
            sensor_type=SensorType.AUDIO,
            data={"volume": 0.3, "pitch": 0.4, "tempo": 0.2, "duration": 5.0},
            timestamp=datetime.now(),
        )
...
class TestSensorIntegration:
    ...
    async def test_multiple_sensor_analysis(self):
        ...
        touch_data = SensorData(
            sensor_type=SensorType.TOUCH,
            data={"pressure": 0.7, "duration": 0.1, "pattern": "rapid_taps"},
            timestamp=datetime.now(),
        )
        ...
        audio_data = SensorData(
            sensor_type=SensorType.AUDIO,
            data={"volume": 0.8, "tempo": 0.9, "pitch": 0.7},
            timestamp=datetime.now(),
        )
