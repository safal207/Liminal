...
# ============================================================================
# Neo4j Components (with global state for backward compatibility)
# ============================================================================
...
def _bind_timeline_bridge(gateway: Neo4jGateway) -> None:
    """Bind the timeline bridge to the memory service."""
    ...
    # Create new bridge and register listener
...
def _ensure_neo4j_components() -> None:
    """Ensure Neo4j components are initialized."""
...
def get_websocket_service() -> TimelineWebSocketService:
    ...
    return _container().websocket_service()
