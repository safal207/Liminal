...
async def test_emotime():
    ...
    print("\n--- Testing Happy Text ---")
    text_data = await text_sensor.process(
        "Amazing day! Everything is wonderful!", {"typing_speed": 5.5}
    )
    ...
    print("\n--- Testing Stress Text ---")
    stress_text = await text_sensor.process(
        "This is terrible!!! Nothing works!", {"typing_speed": 15.0}
    )
