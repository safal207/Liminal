...
class BatchProcessor:
    ...
    async def add_request(self, request_id: str, data: Dict[str, Any]) -> Any:
        ...
        request = BatchRequest(
            id=request_id, data=data, timestamp=datetime.now(), future=future
        )
...
class EmotimeBatchProcessor(BatchProcessor):
    ...
    def __init__(
        self, emotime_engine=None, batch_size: int = 5, batch_timeout: float = 0.5
    ):
    ...
    async def _process_single_emotime_request(
        ...
        try:
            ...
            if current_state:
                ...
                for dim in ["valence", "arousal", "dominance"]:
                    ...
                    enhanced_features[dim] = ml_value * blend_weight + emotime_value * (
                        1 - blend_weight
                    )
                ...
                optimized_confidence = (
                    confidence_optimizer.calculate_overall_confidence(
                        text=text,
                ...
                confidence_explanation = (
                    confidence_optimizer.get_confidence_explanation(calibration)
                )
                ...
                base_confidence = confidence_optimizer.calculate_overall_confidence(
                    text=text
                )
                calibration = confidence_optimizer.analyze_text_confidence(text)
                ...
                return {
                    ...
                    "confidence_breakdown": {
                        ...
                        "context_consistency": calibration.context_consistency,
                        "linguistic_confidence": calibration.linguistic_confidence,
                        "explanations": confidence_optimizer.get_confidence_explanation(
                            calibration
                        ),
                    },
                    "processed_at": datetime.now().isoformat(),
