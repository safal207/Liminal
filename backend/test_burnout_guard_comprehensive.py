...
class BurnoutGuardTestSuite:
        ...
        try:
            ...
            for scenario in test_scenarios:
                ...
                if predicted_risk == scenario["expected_risk"]:
                    ...
                    print(
                        f"    ❌ {scenario['name']}: {predicted_risk} (expected {scenario['expected_risk']})"
                    )
    ...
    async def test_risk_scoring(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if is_correct:
                print(
                    f"    ✅ Risk calculation: {test_score:.3f} (within expected range)"
                )
            else:
                print(
                    f"    ❌ Risk calculation: {test_score:.3f} (outside range {expected_range})"
                )
    ...
    async def test_recommendation_engine(self) -> Dict[str, Any]:
        ...
        try:
            ...
            has_expected = any(
                exp_type in generated_recommendations for exp_type in expected_types
            )
    ...
    async def run_integration_tests(self):
        ...
        integration_results["end_to_end_workflow"] = (
            await self.test_end_to_end_workflow()
        )
        integration_results["real_time_monitoring"] = (
    ...
    async def test_detection_precision(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"passed": False, "details": f"Test failed: {str(e)}"}
    ...
    async def run_security_tests(self):
        ...
        security_results["authentication_security"] = (
