...
_websocket_service_instance: Optional[TimelineWebSocketService] = None
...
def get_websocket_service() -> TimelineWebSocketService:
    ...
    if _websocket_service_instance is None:
        _websocket_service_instance = TimelineWebSocketService(
            manager_service=get_connection_manager_service(),
            memory_service=get_memory_service(),
