...
class TestEmotimeBasics:
    ...
    def test_engine_creation(self):
        ...
        engine = EmotimeEngine(user_id="test_user", enable_neo4j=False)
    ...
    async def test_engine_start_stop(self):
        ...
        engine = EmotimeEngine(
            user_id="test_user", enable_neo4j=False, update_interval=0.1
        )
    ...
    def test_touch_data_creation(self):
        ...
        touch_data = TouchData(pressure=0.7, duration=2.0, frequency=3.0, pattern="tap")
