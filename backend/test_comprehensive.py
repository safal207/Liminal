...
class TestConfig:
    ...
    def test_settings(self):
        ...
        return {
            ...
            "ml": {"ml_enabled": True, "ml_model_cache_size": 10},
        }
    ...
    class TestResilience:
        ...
        async def test_circuit_breaker_recovery(self):
            ...
            circuit = CircuitBreaker(
                "test_recovery", failure_threshold=2, recovery_timeout=0.1
            )
    ...
    class TestMonitoring:
        ...
        async def test_health_monitor(self):
            ...
            monitor.register_health_check(
                HealthCheck("unhealthy_service", unhealthy_check)
            )
...
class IntegrationTests:
    ...
    @pytest.mark.asyncio
    async def test_database_adapter_integration(
        self, mock_datomic_client, mock_neo4j_client
    ):
...
class LoadTests:
    ...
    class LiminalLoadTest(HttpUser):
        ...
        def emotion_entry(self):
            ...
            self.client.post(
                "/api/emotions",
                json={"emotion": "joy", "intensity": 0.7, "context": "load_test"},
                headers=self.headers,
            )
    ...
    async def test_consciousness_monitor_e2e(self):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                await page.goto(
                    "http://localhost:8000/frontend/consciousness_monitor.html"
                )
...
class TestRunner:
    ...
    def run_unit_tests():
        """Run all unit tests."""
        return pytest.main(["test_comprehensive.py::UnitTests", "-v", "--tb=short"])

    @staticmethod
    def run_integration_tests():
        """Run integration tests."""
        return pytest.main(
            ["test_comprehensive.py::IntegrationTests", "-v", "--tb=short"]
        )
...
if __name__ == "__main__":
    ...
    print(
        f"Test Results: Unit={unit_result}, Integration={integration_result}, Performance={performance_result}"
    )
