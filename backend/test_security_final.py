...
def test_neo4j_security():
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location(
            "neo4j_storage", "emotime/neo4j_storage.py"
        )
...
def test_data_encryption():
    ...
    try:
        ...
        class MockEncryptor:
            ...
            def encrypt_emotional_data(self, data, user_id):
                ...
                encrypted_data["_encryption_metadata"] = {
                    "encrypted_fields": [
                        k for k in data.keys() if k in sensitive_fields
                    ],
        ...
        print(
            f"  Encrypted fields: {encrypted.get('_encryption_metadata', {}).get('encrypted_fields', [])}"
        )
